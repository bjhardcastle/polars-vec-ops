...
use super::histogram_parallel::bins_int_parallel_flat;
...
pub(super) fn count_into_bins_uniform_slice_4buf(
    values: &[f64],
    n_bins: usize,
    first: f64,
    last: f64,
...
pub(super) fn finite_values_iter(ca: &Float64Chunked) -> impl Iterator<Item = f64> + '_ {
    ca.into_iter()
